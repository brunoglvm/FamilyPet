              ...
              <ul>
                <li>
                  <FontAwesomeIcon
                    ...
                    className={styles.listItemIcon}
                  />
                  Proporciona uma nova oportunidade para quem precisa de
                  carinho.
                </li>
                <li>
                  <FontAwesomeIcon
          ...
          <div className={styles.educacaoGrid}>
            <div className={styles.educacaoCard}>
              ...
              <p>
                ...
                adequada é essencial para mantê-los saudáveis e cheios de
                energia. Exercícios regulares, como passeios e brincadeiras,
                ajudam a reduzir o estresse e melhorar o comportamento. Além
                disso, consultas veterinárias periódicas garantem que a saúde do
                seu amigo peludo esteja sempre em dia.
              </p>
            </div>
            <div className={styles.educacaoCard}>
            ...
            <div className={styles.educacaoCard}>
              ...
              <p>
                ...
                abandono. Além disso, castrar os animais reduz o risco de
                doenças graves, como tumores e infecções, melhorando sua
                qualidade de vida.
              </p>
            </div>
          </div>
